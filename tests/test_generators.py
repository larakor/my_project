...
def test_filter_by_currency(transactions, value, expected):
    test_value = filter_by_currency(transactions, value)
...
"""Тестирование генератора transactions_description"""
